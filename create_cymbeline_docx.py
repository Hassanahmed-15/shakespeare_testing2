...
def main():
    # Read the JSON file
    json_file = "Public/Data/cymbeline.json"
    ...
    # Add title: "Cymbeline" (bold, highlighted)
    add_highlighted_heading(doc, "Cymbeline")
    ...
    # Save the document
    output_file = "Cymbeline_With_Line_Numbers.docx"
