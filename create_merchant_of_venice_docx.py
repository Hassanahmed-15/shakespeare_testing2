...
def main():
    ...
    # Add title: "The Merchant of Venice" (bold, highlighted)
    add_highlighted_heading(doc, "The Merchant of Venice")
    ...
    # Save the document
    output_file = os.path.join(script_dir, "The_Merchant_of_Venice_With_Line_Numbers.docx")
