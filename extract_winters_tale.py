...
def extract_text_from_scene(act, scene):
    ...
    url = f"https://shakespeare.mit.edu/winters_tale/winters_tale.{act}.{scene}.html"
...
def extract_play_text():
    """Extract all text from The Winter's Tale"""
    all_scenes = {}
    
    # The Winter's Tale structure:
    # Act 1: 2 scenes
    # Act 2: 3 scenes
    # Act 3: 3 scenes
    # Act 4: 4 scenes
...
def main():
    print("Extracting The Winter's Tale from MIT Shakespeare website...")
    print("=" * 60)
    
    # Get the script directory and construct the path
    script_dir = os.path.dirname(os.path.abspath(__file__))
    json_file = os.path.join(script_dir, "Public", "Data", "the_winters_tale.json")
    ...
    expected_scenes = [
        ...
        "ACT 5 SCENE 1", "ACT 5 SCENE 2", "ACT 5 SCENE 3"
    ]
