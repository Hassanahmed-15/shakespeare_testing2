...
def extract_text_from_scene(act, scene):
    ...
    url = f"https://shakespeare.mit.edu/john/john.{act}.{scene}.html"
...
def main():
    print("Extracting missing scenes from King John...")
    print("=" * 60)
    
    # Get the script directory and construct the path
    script_dir = os.path.dirname(os.path.abspath(__file__))
    json_file = os.path.join(script_dir, "Public", "Data", "king_john.json")
    ...
    # Extract ACT 3 SCENE 2 and ACT 3 SCENE 3
    scenes_to_extract = [
        (3, 2),
        (3, 3)
    ]
    ...
    print(f"Added {len(new_scenes)} scenes")
