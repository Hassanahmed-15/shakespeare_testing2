#!/usr/bin/env python3
"""
GUARANTEED SHAKESPEARE CONSECUTIVE SPEAKER CLEANER
This script will 100% remove consecutive duplicate speaker names.
"""
    ...
    try:
        ...
        for scene_name, scene_data in data.items():
            ...
            for _, line_num in line_numbers:
                ...
                # Check for speaker pattern: "NAME: dialogue"
                # Look for ALL CAPS name followed by colon
                ...
                if match:
                    ...
                    clean_speaker = re.sub(r'[^A-Z\s]', '', speaker).strip()
...
def main():
    ...
    print("🎭 GUARANTEED SHAKESPEARE CONSECUTIVE SPEAKER CLEANER 🎭")
    print("=" * 60)
    ...
    print("✅ All Shakespeare plays are now clean!")
    print("=" * 60)
