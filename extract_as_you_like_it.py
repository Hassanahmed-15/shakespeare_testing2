...
def extract_text_from_scene(act, scene):
    ...
    url = f"https://shakespeare.mit.edu/asyoulikeit/asyoulikeit.{act}.{scene}.html"
...
def extract_play_text():
    """Extract all text from As You Like It"""
    all_scenes = {}
...
def main():
    print("Extracting As You Like It from MIT Shakespeare website...")
    print("=" * 60)
    
    # Read existing file to preserve DRAMATIS PERSONAE
    existing_file = "Public/Data/as_you_like_it.json"
    existing_data = {}
    ...
    # Write to file
    output_file = "Public/Data/as_you_like_it.json"
