...
def main():
    ...
    # Add title: "The Winter's Tale" (bold, highlighted)
    add_highlighted_heading(doc, "The Winter's Tale")
    ...
    # Save the document
    output_file = os.path.join(script_dir, "The_Winters_Tale_With_Line_Numbers.docx")
