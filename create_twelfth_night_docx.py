...
def main():
    ...
    # Add title: "Twelfth Night" (bold, highlighted)
    add_highlighted_heading(doc, "Twelfth Night")
    ...
    # Save the document
    output_file = os.path.join(script_dir, "Twelfth_Night_With_Line_Numbers.docx")
