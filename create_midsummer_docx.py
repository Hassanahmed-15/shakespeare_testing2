...
def main():
    # Read the JSON file
    json_file = "Public/Data/midsummer_nights_dream.json"
    ...
    # Add title: "A Midsummer Night's Dream" (bold, highlighted)
    add_highlighted_heading(doc, "A Midsummer Night's Dream")
    ...
    # Save the document
    output_file = "A_Midsummer_Nights_Dream_With_Line_Numbers.docx"
