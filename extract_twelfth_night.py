...
def extract_text_from_scene(act, scene):
    ...
    url = f"https://shakespeare.mit.edu/twelfth_night/twelfth_night.{act}.{scene}.html"
...
def extract_play_text():
    """Extract all text from Twelfth Night"""
    all_scenes = {}
...
def main():
    print("Extracting Twelfth Night from MIT Shakespeare website...")
    print("=" * 60)
    ...
    expected_scenes = [
        ...
        "ACT 2 SCENE 1", "ACT 2 SCENE 2", "ACT 2 SCENE 3", "ACT 2 SCENE 4", "ACT 2 SCENE 5",
