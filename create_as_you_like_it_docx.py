...
def main():
    # Read the JSON file
    json_file = "Public/Data/as_you_like_it.json"
    ...
    # Add title: "As You Like It" (bold, highlighted)
    add_highlighted_heading(doc, "As You Like It")
    ...
    # Save the document
    output_file = "As_You_Like_It_With_Line_Numbers_Updated.docx"
